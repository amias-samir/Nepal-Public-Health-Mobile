...
public class ChildrenUnderFive extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    public static Toolbar children_under_5_toolbar;
    int CAMERA_PIC_REQUEST = 2;
    Spinner spinner_diarrhoea_details,spinner_treated_zinc_diarrhoea,spinner_referred_diarrhoea,
            spinner_ari_details,spinner_treated_zinc_ari,spinner_referred_ari;
    ArrayAdapter diarrhoea_details_adpt, treated_zinc_diarrhoea_adpt, referred_diarrhoea_adpt,ari_details_adpt,
             treated_zinc_ari_adpt, referred_ari_adpt ;
    ...
    String child5_name, child5_vdc_name, child5_ward_no, child5_age, child5_sex, child5_sm_name,
        visit_date, visit_time, img, diarrhoea_details, treated_zinc_diarrhoea,refered_diarrhorea_by,
            ari_details,treated_zinc_ari,refered_ari_by;
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        if (SpinnerID==R.id.treated_zinc_diarrhoea_spinner){

            switch (position){
                case 0:
                    treated_zinc_diarrhoea = "Yes";
                    break;
                case 1:
                    treated_zinc_diarrhoea = "No";
                    break;
        ...
        if (SpinnerID == R.id.referred_diarrhoea_spinner){

            switch (position){

                case 0:
                    refered_diarrhorea_by = "Yes";
                    break;

                case 1:
                    refered_diarrhorea_by = "No";
                    break;
            }
        }
        ...
        if (SpinnerID == R.id.treated_zinc_ari_spinner){
            switch (position){
                case 0:
                    treated_zinc_ari = "Yes";
                    break;
        ...
        if (SpinnerID == R.id.referred_ari_spinner){
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvchildren_5_ward_no = (AutoCompleteTextView)findViewById(R.id.children_ari_under_5_details);
        ...
        spinner_treated_zinc_diarrhoea = (Spinner)findViewById(R.id.treated_zinc_diarrhoea_spinner);
        spinner_referred_diarrhoea = (Spinner)findViewById(R.id.referred_diarrhoea_spinner);
        spinner_ari_details = (Spinner)findViewById(R.id.suffered_from_ARI);
        spinner_treated_zinc_ari = (Spinner)findViewById(R.id.treated_zinc_ari_spinner);
        spinner_referred_ari = (Spinner)findViewById(R.id.referred_ari_spinner);
        ...
        //check wheather get zinc for treating diarrhoea
        treated_zinc_diarrhoea_adpt =
                new ArrayAdapter<String >(this,android.R.layout.simple_spinner_item,Constants.YES_NO);
        treated_zinc_diarrhoea_adpt.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinner_treated_zinc_diarrhoea.setAdapter(treated_zinc_diarrhoea_adpt);
        spinner_treated_zinc_diarrhoea.setOnItemSelectedListener(this);

        // check refer by some one
        referred_diarrhoea_adpt =
                new ArrayAdapter<String>(this,android.R.layout.simple_spinner_item,Constants.YES_NO);
        referred_diarrhoea_adpt.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinner_referred_diarrhoea.setAdapter(referred_diarrhoea_adpt);
        spinner_referred_diarrhoea.setOnItemSelectedListener(this);
        ...
        // check wheather zinc is treated for ari
        treated_zinc_ari_adpt =
                new ArrayAdapter<String>(this,android.R.layout.simple_spinner_item,Constants.YES_NO);
        treated_zinc_ari_adpt.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinner_treated_zinc_ari.setAdapter(treated_zinc_ari_adpt);
        spinner_treated_zinc_ari.setOnItemSelectedListener(this);

        // check refer by someone for ari
        referred_ari_adpt =
                new ArrayAdapter<String>(this,android.R.layout.simple_spinner_item,Constants.YES_NO);
        referred_ari_adpt.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinner_referred_ari.setAdapter(referred_ari_adpt);
        spinner_referred_ari.setOnItemSelectedListener(this);
...
//        Bitmap bm = BitmapFactory.decodeFile( imagePath ,options);
    ...
    public void convertDataToJson() {
        ...
        try {
            ...
            diarroheaJson.put("diarrhoea_details",diarrhoea_details);
            diarroheaJson.put("diarrhoea_refered",refered_diarrhorea_by);
            diarroheaJson.put("diarrhoea_treated_zinc",treated_zinc_diarrhoea);

            ariJson.put("ari_details",ari_details);
            ariJson.put("ari_refered",refered_ari_by);
            ariJson.put("ari_treated_zinc",treated_zinc_ari);
